...
function createFeedback() {
    let selectedPoint = document.querySelector(".point-evaluation_item.active");
...
function editFeedback(id) {
    ...
    if (feedback) {
        let reviewInput = document.getElementById('comment');
        let pointItems = document.querySelectorAll('.point-evaluation_item');
...
function updateFeedback(id) {
    ...
    const selectedPoint = document.querySelector('.point-evaluation_item.active');
